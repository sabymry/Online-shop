      ...
      <div class="summary">
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"><i class="fas fa-euro"></i> <?= $fetch_get['price']; ?> x 1</p>
            </div>
         </div>
         <?php
               }
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"><i class="fas fa-euro"></i> <?= $fetch_product['price']; ?> x <?= $fetch_cart['qty']; ?></p>
            </div>
         </div>
         <?php
                  }
         ...
         ?>
         <div class="grand-total"><span>grand total :</span><p><i class="fas fa-euro"></i> <?= $grand_total; ?></p></div>
      </div>
