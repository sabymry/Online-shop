...
<section class="order-details">
   ...
   <div class="box">
      <div class="col">
         ...
         <p class="price"><i class="fas fa-euro"></i> <?= $fetch_order['price']; ?> x <?= $fetch_order['qty']; ?></p>
         <h3 class="name"><?= $fetch_product['name']; ?></h3>
         <p class="grand-total">grand total : <span><i class="fas fa-euro"></i> <?= $grand_total; ?></span></p>
      </div>
      <div class="col">
